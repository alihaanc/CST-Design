...
files=s:h-field (f=2)_2,1.m3d
files=s:h-field (f=2)_2,1_m3d.rex
...
files=s:h-field (f=2)_2,1.m3d
files=s:h-field (f=2)_2,1_m3d_sct.rex
...
result=s:1
user_delete=s:1
treepath=s:1D Results\Eye Diagram\Calculating eye\Calculating
files=s:itmp_calculating.sig
